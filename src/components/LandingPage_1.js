        ...
        >
          ...
          <div className="flex flex-col text-custom-blue space-y-8 w-2/5 p-8 bg-gray-800 shadow-lg ml-4 rounded-lg transition-transform duration-10000 ease-in-out transform hover:scale-105">
            <div className="space-y-4">
              <p className="text-lg font-mono">DocPad is a blockchain-powered Electronic Health Records (EHR) system designed to provide secure, transparent, and efficient healthcare data management. By integrating blockchain for data integrity, AI for smart insights, and IPFS for decentralized storage, DocPad ensures that medical records remain tamper-proof, easily accessible to doctors, and fully controlled by patients. With enhanced security, seamless interoperability, and automated workflows, DocPad transforms the way healthcare data is managed, improving patient trust, doctor-patient interactions, and overall healthcare efficiency.                </p>
            </div>
          </div>
        </div>
      </div>
