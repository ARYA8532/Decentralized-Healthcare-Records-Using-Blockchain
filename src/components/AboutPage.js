        ...
        <div className="flex flex-col text-custom-blue space-y-8 w-3/5 p-8 bg-gray-800 shadow-lg rounded-lg transition-transform duration-10000 ease-in-out transform hover:scale-105">
          <div className="space-y-4">
            ...
            <div className="about-content text-left"> {/* Left align the content */}
              <h2>Who We Are</h2>
              <p>
              We are a dedicated team of    engineering students from BE-IT-A, passionate about leveraging 
              blockchain and AI to revolutionize healthcare data management. Our project, DocPad, is 
              designed to provide a secure, decentralized, and user-friendly platform.
              </p>

              <h2>Meet Our Team</h2>
              <ul>
                <li><strong>Viraj Salvi</strong> - Blockchain & Smart Contracts Developer</li>
                <li><strong>Arya Dhuri</strong> - AI Integration(Research) & Data Security</li>
                <li><strong>Shrish Kadam</strong> - Backend & Database Management</li>
                <li><strong>Pranav Bangar</strong> - Frontend & UI/UX Design</li>
              </ul>
